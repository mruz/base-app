                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="header-collapse">
                        ...
                        {% if ! auth.logged_in() %}
                            ...
                            <div class="checkbox"><label>{% set field = 'rememberMe' %}{{ checkField(_POST[field] is definied and _POST[field] == 'on' ? [ field, 'value': 'on', 'checked': 'checked' ] : [ field, 'value': 'on' ]) }} {{ __(field|label) }}</label></div>
